...
def query(meanDf, barDf, ids, conditions, cols=None, figsize=(6, 4), title='', ylims=None, xs=None,
            plotType='bar', queryConditionGroupNames=None, xlabels=[], xlabelRotation=0, **kwargs):
    ...
    ha = calHash(meanDf, barDf, ids, conditions, cols, figsize, title, ylims, xs,
                 plotType, queryConditionGroupNames, xlabels, xlabelRotation) ## TODO add kwargs to calHashk
